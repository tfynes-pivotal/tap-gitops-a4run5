...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-a4run5
echo     https://github.com/tfynes-pivotal/tap-gitops-a4run5
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-a4run5 --private
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-a4run5
git branch -M main
